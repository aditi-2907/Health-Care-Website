...
def predict_disease_probabilities(symptoms):
    ...
    filtered_probabilities = {disease: probability * 100 for disease, probability in zip(model.classes_, disease_probabilities[0]) if probability >= threshold}
...
def add_data():
    try:
        ...
        add_data_to_excel('sample_data.xlsx', symptoms, text_input)
